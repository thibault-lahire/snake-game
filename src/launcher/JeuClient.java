...
/**
 * This class launches the game for a client in a network. The client controls
 * his/her snake. When the game is finished, the result appears in the console
 * 
 * @author t.lahire
 */
public class JeuClient extends Game {

	/**
	 * This egg represents the head of the first snake. It will be actualized at
	 * each step of the game thanks to the communication with the server
	 */
	private Egg egg1;
	 ...
	 * @throws IOException
	 */
	public JeuClient() throws IOException {
	...
	public ArrayList<Node> gameStep() {
		try {
			...
			if (egg1.alive == true && egg2.alive == true) {
				...
				objectOutput.writeObject(new Egg(egg2.x, egg2.y, Color.ALICEBLUE));
				object = objectInput.readObject();
				Egg new_egg1 = (Egg) object;
				egg1 = new Egg(new_egg1.x, new_egg1.y, Color.ORANGE);
