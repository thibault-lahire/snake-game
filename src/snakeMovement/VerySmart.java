 ...
 * @author t.lahire
 */
public class VerySmart extends Movement {
	 ...
	 * @param allEggs
	 */
	public VerySmart(Egg egg, ArrayList<Egg> allEggs1, ArrayList<Egg> allEggs) {
		super(egg, allEggs1, allEggs);
	}

	/**
	 * This method offers a very smart snake, because the movement of the snake is
	 * oriented in the direction of the head of the other snake. To choose one of
	 * the free directions among "Forward, Left, and Right", the method evaluates
	 * the distance between the next position and the position of the head of the
	 * other snake. Then, the method chooses the minimum distance.
	 * 
	...
	public void move(Egg egg0) {
		if (egg.alive == true) {
			...
			Egg egg1 = allEggs1.get(allEggs1.size() - 1); // egg1 is the head of the other snake
